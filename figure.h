...
/**
    ...
    <p><b>Summary:</b>Function that moves figure (needed because rotations are coded beforehand, but are placed on the center, this function moves those rotations of the figure left or right to where it is supposed to be, of course only if it is possible).</p>
